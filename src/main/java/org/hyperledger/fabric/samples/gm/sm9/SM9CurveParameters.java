package org.hyperledger.fabric.samples.gm.sm9;
...
public class SM9CurveParameters {
    public static int nBits = 256; //The number of bits for the order N of the subgroup G1/G2

    public static BigInteger b = BigInteger.valueOf(5);
    public static BigInteger t = new BigInteger("600000000058F98A", 16);
    public static BigInteger q = new BigInteger("B640000002A3A6F1D603AB4FF58EC74521F2934B1A7AEEDBE56F9B27E351457D", 16);
    public static BigInteger N = new BigInteger("B640000002A3A6F1D603AB4FF58EC74449F2934B18EA8BEEE56EE19CD69ECF25", 16);

    public static BigInteger beta = new BigInteger("B640000002A3A6F1D603AB4FF58EC74521F2934B1A7AEEDBE56F9B27E351457B", 16);
    public static BigInteger alpha0 = BigInteger.ZERO;
    public static BigInteger alpha1 = new BigInteger("B640000002A3A6F1D603AB4FF58EC74521F2934B1A7AEEDBE56F9B27E351457C", 16);
