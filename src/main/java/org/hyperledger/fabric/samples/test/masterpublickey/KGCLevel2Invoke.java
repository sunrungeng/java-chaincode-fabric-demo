...
public class KGCLevel2Invoke {
    public static void main(String[] args) {
        ...
        if (here.equals("client")) {
            System.out.println("KGC2 is not top level KGC,  delegate KGC1 to invoke master public key for \"stone\" ...");
            MasterPublicKeyRequest masterPublicKeyRequest = new MasterPublicKeyRequest(configProperties);
            System.out.println(masterPublicKeyRequest.invokeMasterPublicKey("stone"));
        } else {
