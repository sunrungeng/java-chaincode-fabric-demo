...
public class ServiceDomainAUser {
    public static void main(String[] args) throws Exception{
        ...
        try {
            while (true) {
                String deviceID = "master";
                System.out.println("设备标识：" + deviceID);

                String timestamp = String.valueOf(System.currentTimeMillis());
                String attachInfo = "LINKE.CS.USTC.EDU" + "." + timestamp;
...
//                Socket socket = new Socket("localhost", 63363);
                ...
                printStream.println("stone");
                printStream.println("add");
                printStream.println("guest.LINKE.CN.USTC.EDU");
